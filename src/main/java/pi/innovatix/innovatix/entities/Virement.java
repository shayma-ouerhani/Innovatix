...
public class Virement {
    ...
    private int actions_v ;
    private int  actions_em ;
    private String photo_cin_v ;
    private String phone_number ;


    public Virement(int id, int compte_id, int user_id, String nomet_prenom, String type_virement, String transferez_a, int num_beneficiare, int montant, int cin, int rib, String email, String decision_v, int actions_v, int actions_em, String photo_cin_v, String phone_number) {
        this.id = id;
        ...
        this.actions_v = actions_v;
        this.actions_em = actions_em;
    ...
    public int getActions_v() {
        return actions_v;
    }

    public void setActions_v(int actions_v) {
        this.actions_v = actions_v;
    }

    public int getActions_em() {
        return actions_em;
    }

    public void setActions_em(int  actions_em) {
        this.actions_em = actions_em;
    }
